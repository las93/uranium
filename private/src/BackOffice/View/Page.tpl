                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">{gettext word='AllPages'} <a href="{url alias='page_add'}"><i class="fa fa-plus"></i></a></h3>
                                    <div class="box-tools">
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{url alias='page_update' id=$oPage->get_id()}"><i class="fa fa-edit"></i></a>
                                                &nbsp;&nbsp;&nbsp;
