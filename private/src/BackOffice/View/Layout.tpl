...
<html>
    <head>
        <meta charset="UTF-8">
        <title>{$app.const.WEBSITE_TITLE} | {if $title}{$title}{else}Homepage{/if}</title>
    ...
    <body class="skin-blue">
        ...
        <header class="header">
            <a href="{url alias='home'}" class="logo">
                <!-- Add the class icon to your logo image or logo icon to add the margining -->
                {$app.const.WEBSITE_TITLE}
            </a>
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown tasks-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="header">{gettext word='ChooseYourLanguage'}</li>
                                <li>
                                    <!-- inner menu: contains the actual data -->
                                    <ul class="menu">
                                        {foreach from=$aLanguage item=$aOne}
                                        <li><!-- Task item -->
                                            <a href="?language={$aOne['i18n']}">
                                                <h3>
                                                    <img src="{$aOne['flag']}">
                                                    <small class="pull-right">{$aOne['title']}</small>
                                                </h3>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p>{gettext word='Hello'}, {$aUser->get_login()}</p>
                    ...
                    <ul class="sidebar-menu">
                        <li>
                            <a href="{url alias='page'}">
                                <i class="fa fa-th"></i> <span>{gettext word='Page'}</span>
                            </a>
                        </li>
                        <!--
                        <li class="treeview">
